...
> Answer: Instead re-rendering the whole page, only components have to re-render. The browser processes all of this instead of making extra requests from the server.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: A component that takes in values and can re-render itself to make changes.
